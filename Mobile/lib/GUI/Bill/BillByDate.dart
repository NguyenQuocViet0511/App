...
List<bill>? bills;
class BillByDate extends StatefulWidget{
  String date ='';
   BillByDate({super.key,required this.date});

  @override
  State<BillByDate> createState() => _BillByDateState();
}

class _BillByDateState extends State<BillByDate> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child:Column(
          children: [
            Expanded(child: RowBill(date: widget.date))
          ],
        ),
...
class RowBill extends StatefulWidget {
  String date ='';
   RowBill({super.key,required this.date});
...
class _RowBill extends State<RowBill> {
  ...
  @override
  void initState() {
    billDatas = GetbillByDate(widget.date);
    print(widget.date);
    super.initState();
  }
  @override
                      ...
                      InkWell(
                        onTap: () {
                          Navigator.push(context, PageRouteBuilder(pageBuilder: (
                              ...
                              SeeBillinfo(idbill: item.id.toString())));
                        },
                        child: Container(
